---
title: "Text and Sentiment Analysis: Songs from <i>Shang-Chi and the Legend of the Ten Rings: The Album</i>"
description: |
...
author:
  - name: Shuying Yu
citation_url: https://esswhy.github.io/projects/text_analysis_shangchi/
date: 03-19-2022
categories:
  - Text Analysis
  - R
...
```{r album-cover, fig.align="center", fig.height=3, fig.width=3}
#Add Shang-Chi album cover
knitr::include_graphics(here("_projects", "text_analysis_shangchi",
...
```{r table-songs}
#Read in the data
shangchi <- read_xlsx(here("_projects", "data", "shangchi_ost.xlsx"))
...
shangchi %>% 
  ...
  kable(col.names = c("Track Number", "Song Name", "Artist Names"),
        ...
        #Add caption
        caption = "Track number, song name, and artist names are 
                  displayed for each song from <i>Shang-Chi and the Legend of the Ten 
                  Rings: The Album</i>. Data source: Marvel (2021).",
