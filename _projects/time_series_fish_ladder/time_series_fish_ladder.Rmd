...
author:
  - name: Shuying Yu
citation_url: https://esswhy.github.io/projects/time_series_fish_ladder/
date: 03-02-2022
categories:
...
```{r fish-ladder, echo=FALSE, fig.align = "center", results = "markup", out.width= '100%', out.height= '100%'}
#Add fish ladder diagram
knitr::include_graphics(here::here("_projects", "time_series_fish_ladder", "fish_ladder.gif"))
```


![Willamatte River.](willamette_river.jpg)
...
```{r}
#Read in the data
salmon <- read_csv(here("_projects", "data", "willamette_fish_passage.csv"))
