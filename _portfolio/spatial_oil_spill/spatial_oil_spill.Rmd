...
author:
  - name: Shuying Yu
citation_url: https://esswhy.github.io/portfolio/spatial_oil_spill/
date: 03-02-2022
categories:
  - Spatial Analysis
  - R
...
ca_counties_sf <- read_sf(here("_portfolio", "data", "ca_county_boundaries",
...
ca_spills_sf <- read_sf(here("_portfolio", "data", "ds394", "ds394.shp")) %>% 
