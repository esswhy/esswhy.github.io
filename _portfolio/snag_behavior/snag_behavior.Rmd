...
#Read in data
corr_dat <- read_csv(here("data", "snag_behavior_correlations.csv"))
...
Visualize correlation matrix using correlogram. http://www.sthda.com/english/wiki/visualizecorrelation-
matrix-using-correlogram
